...
public class RRR extends AppCompatActivity {
    ...
    private DocumentReference dbref=db.collection("Events").document("RRR");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timeView=findViewById(R.id.rrrtime);
        venueView=findViewById(R.id.rrrvenue);
        dayView=findViewById(R.id.rrrday);
        ...
        dbref.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()){
                    ...
                    Toast.makeText(RRR.this, "doesn't exist", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(RRR.this, "Please Enable Mobile Data", Toast.LENGTH_SHORT).show();
            }
        });
    }
    protected void onStart() {
        ...
        dbref.addSnapshotListener(this,new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if(e!=null){
                    Toast.makeText(RRR.this, "error while loading", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(documentSnapshot.exists()){
                    String time=documentSnapshot.getString(KEY_TIME);
